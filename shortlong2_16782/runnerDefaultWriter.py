...
def run(netfile, rerouters, sumoconfig):
    ...
    (testnetfile, testroutefile) = readSumoCfg(sumoconfig) #TODO: THIS WORKS! Use it!
    routefileparts = testroutefile.split(".")
    routefileparts[0] = routefileparts[0]+"_auto"
    routefilename = ""
...
""", file=routefile)
        ...
        # with open("blocksturnratios.pickle", 'rb') as handle:
