...
for p in [0.95, 0.99]: #[0.95, 0.99, 0.75, 0.5, 0.01, 0.9, 0.05, 0.25, 0.8, 0.85]: #[0.01, 0.5, 0.75, 0.99, 0.95, 0.9, 0.05, 0.25, 0.8, 0.85]:
    print(p)
    if not p in data:
        data[p] = dict()
        data[p]["All"] = []
    ...
    for i in range(0, nIters):
        print(i)
        newdata = runnerQueueSplit11Threaded.main(sys.argv[1], p, False)
