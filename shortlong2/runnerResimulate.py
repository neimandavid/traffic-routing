...
def getShortestRoute(routes, vehicle):
    ...
    for route in routes:
        ...
        if t < besttime:
            ...
            bestroute = route
    traci.switch("main")
    #Without dontBreakEverything, switching back clears vehicles somehow?
    #traci.simulation.loadState("teststate.xml") #Apparently needed, else vehicle list is empty?
    return bestroute
